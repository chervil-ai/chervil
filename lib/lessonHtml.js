...
function appletInner(c) {
  // Snapshot (published/exported): a baked answer, computed at publish time with
  // the author's local key — no live bridge needed. Otherwise (in-app): a live
  // "Try it" button wired to window.chervil.ask.
  if (c.answer) {
