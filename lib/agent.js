...
async function runChat({ query, history = [], profile = null, config = {} }) {
...
module.exports = { runAgent, runChat, runAgentTurn, runAppletAsk, runComposeApplet, runListModels, runAgentStep, runAgentPlan, runExtractSlides, runExtractDoc, runExtractSheets, runSynthesizeAgent, runBuildLesson, runBuildQuiz };
