...
async function runChat({ query, history = [], profile = null, pageContext = null, pageMeta = null, tabsContext = null, config = {} }) {
  ...
  let system = chatSystem(canSearch) + chatDateAddendum();
  ...
  if (useReply) {
    ...
    const { text, sources } = await provider.chatReply({ system, messages, maxTokens: 1500 });
