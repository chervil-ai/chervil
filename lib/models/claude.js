...
function createClaudeProvider(config = {}) {
  ...
  return {
    ...
    async run({
      ...
      recallMode = 'find',  // what to DO with recallContext: 'find' (re-find a page) | 'synthesize' (a dossier)
      ...
      if (!verify) {
        ...
        if (recallContext) system += (recallMode === 'synthesize' ? DOSSIER_ADDENDUM : RECALL_ADDENDUM);
