...
RICH MODE — the user wants a visually rich, information-dense page. Go further than usual: a clear visual hierarchy with section headings and generous whitespace; callout/summary boxes for key takeaways; comparison tables where they aid understanding; inline SVG charts, diagrams, or simple visualizations for any data or relationships; and tasteful color and typography. Prefer showing structure (cards, grids, timelines) over long prose. Keep it self-contained and fast (inline styles/SVG, vanilla JS only) — never sacrifice correctness or readability for decoration.`;
